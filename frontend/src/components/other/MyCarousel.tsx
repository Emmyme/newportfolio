                  ...
                  >
                    <AccordionItem value="item-1" className="text-center">
                      ...
                      <AccordionContent>
                        ...
                        name.</p>
                        <a href="https://emmyme.github.io/quiz/" className="font-body p-2 text-base text-white bg-secondary-background hover:bg-background rounded-lg">Visit</a>
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </Card>
                ...
                <Card className="md:p-2 flex flex-col p-0 gap-0 rounded-none md:rounded-xl md:gap-4">
                  ...
                  >
                    <AccordionItem value="item-1" className="text-center">
                      <AccordionTrigger>Read more</AccordionTrigger>
                      <AccordionContent>
                        <p className="pb-6 text-base">A mock e-commerce website. It is a fullstack application
                        ...
                        TypeScript.</p>
                        <a href="https://github.com/Emmyme/plantz-webshop" className="font-body p-2 text-base text-white bg-secondary-background hover:bg-background rounded-lg">View code</a>
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </Card>
                ...
                <Card className="md:p-2 flex flex-col p-0 gap-0 rounded-none md:rounded-xl md:gap-4">
                  ...
                  >
                    <AccordionItem value="item-1" className="text-center">
                      <AccordionTrigger>Read more</AccordionTrigger>
                      <AccordionContent>
                        <p className="pb-6 text-base">My previous portfoliosite was made with Vue.js (Vue
                        Router), HTML and CSS. It was designed in Figma and made
                        responsive using CSS grid and flexbox.</p>
                        <a href="https://emmyme.github.io/portfolio/" className="font-body p-2 text-base text-white bg-secondary-background hover:bg-background rounded-lg">Visit</a>
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </Card>
                ...
                <Card className="md:p-2 flex flex-col p-0 gap-0 rounded-none md:rounded-xl md:gap-4">
                  ...
                  >
                    <AccordionItem value="item-1" className="text-center">
                      <AccordionTrigger>Read more</AccordionTrigger>
                      <AccordionContent>
                        <p className="pb-6 text-base">A daily planner designed in Figma. It was made with
                        ...
                        your recent moods.</p>
                        <a href="https://emmyme.github.io/daily-planner/" className="font-body p-2 text-base text-white bg-secondary-background hover:bg-background rounded-lg">Visit</a>
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </Card>
